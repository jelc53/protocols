...
export default class MessengerClient {
  ...
  async generateCertificate(username) {
    ...
    this.self_sec = keypairObject.sec;
    this.self_pub = keypairObject.pub;
  ...
  */
  async initiateConn(certificate) {
    ...
    let sharedSecret = await computeDH(this.self_sec, certificate.pub);

    // Add Bob to list of active connections
    this.conns[certificate.username] = { 
      "self_pub": this.self_pub,         // store current version of alice's eg keypair
  ...
  */
  ...
  async sendMessage(name, plaintext) {
   ...
   let header = {
    "ivMsg": ivMsg,
    "username": this.self_cert.username,
